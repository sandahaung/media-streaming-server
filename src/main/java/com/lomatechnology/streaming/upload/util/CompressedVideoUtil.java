...
public class CompressedVideoUtil {
    ...
    public String generateThumbnail(String filename, long id) throws IOException {
        ...
        String outputLocation = new StringBuilder(dirPath)
                .append(File.separator).append("thumbnail").append(id).append(".").append("png").toString();
...
//                config video
        ...
        executor.createJob(builder, new ProgressListener() {
            ...
            public void progress(Progress progress) {
                ...
                if (progress.status.equals(Progress.Status.END)) {
                    ...
                    logger.info("filename: {} -> {} status: {} time: {} ms",
    ...
    public String convertVideoForStorage(String filename, long id, String format, VideoConversionCompleted videoConversionCompleted) throws IOException {    	
        String dirPath = new StringBuilder(getHomeDirectory()).append(File.separator)
                .append("Videos").append(File.separator)
                .append("compressed").append(File.separator)
                .append(LocalDate.now()).toString();
        ...
        String outputLocation = new StringBuilder(dirPath)
                .append(File.separator).append("compressed").append(id).append(".").append(format).toString();
        FFmpegProbeResult input = ffprobe.probe(filename);
        FFmpegBuilder builder = new FFmpegBuilder()
                .setInput(input).overrideOutputFiles(true)
